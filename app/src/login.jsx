    ...
    return (
        ...
        <Modal className="p-12"
               activator={({ setShow }) => (
                ...
                <button className="relative top-4 md:top-48 mx-1 px-2 md:px-4 py-2 bg-indigo-700 transition duration-150 ease-in-out hover:bg-indigo-500 text-xs font-bold"
                        type="button"
